...
class Task(BaseTask):
    ...
    def teste_2_dragao_img(self):
        assert (
            isfile("dragao.png") or isfile("dragao.jpg")
        ), "deve haver uma imagem dragao.jpg ou dragao.png"

    def teste_3_maximo(self):
        arquivo = "maximo.md"
        n_words = 60
