...
class Task(BaseTask):
    def teste_1_compras_pequeno(self):
        script = "compras.py"
        self.exists(script)
        self.test_cases(script, self.case_range("compras{}.in", 1, 4))

    def teste_2_compras_medio(self):
        script = "compras.py"
        self.exists(script)
        self.test_cases(script, self.case_range("compras{}.in", 5, 7))

    def teste_3_compras_grande(self):
        script = "compras.py"
        self.exists(script)
        self.test_cases(script, self.case_range("compras{}.in", 8, 9))

    def teste_4_cadeias_pequeno(self):
        script = "cadeias.py"
        self.exists(script)
        self.test_cases(script, self.case_range("cadeias{}.in", 1, 4))

    def teste_5_cadeias_medio(self):
        script = "cadeias.py"
        self.exists(script)
        self.test_cases(script, self.case_range("cadeias{}.in", 5, 6))

    def teste_6_cadeias_grande(self):
        script = "cadeias.py"
        self.exists(script)
        self.test_cases(script, self.case_range("cadeias{}.in", 7, 9))
